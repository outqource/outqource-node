...
class Generator {
  ...
  static async generate(root, dest) {
    ...
    return await __classPrivateFieldGet(generator, _Generator_instances, 'm', _Generator_generate).call(generator);
  }
}
...
(_Generator_root = new WeakMap()),
  ...
  (_Generator_generate = async function _Generator_generate() {
    ...
    return await tree.writeFiles(__classPrivateFieldGet(this, _Generator_dest, 'f'), true);
  });
