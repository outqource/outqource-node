...
const createPrismaGetController = (database, controllerAPI, options) => {
    ...
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const pagination = {};
        const findOptions = Object.assign(Object.assign({}, (options.options || {})), { where: (resultOptions === null || resultOptions === void 0 ? void 0 : resultOptions.where) || {}, select: (_a = options.options) === null || _a === void 0 ? void 0 : _a.select });
        const countOptions = {
        ...
        try {
            let count = 0;
            if (isCount) {
                count = yield db[table].count(countOptions);
...
const createPrismaPostController = (database, _, options) => {
    ...
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const resultOptions = getTraverseOption(req, options.options || {});
            const row = yield db[table][action](resultOptions);
...
const createPrismaDeleteController = (database, _, options) => {
    ...
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const findRow = yield db[table].findFirst({ where: resultOptions.where });
            if (!findRow) {
                throw { status: 404, message: `NotFound ${table} data!` };
            }
            const row = yield db[table][action](resultOptions);
...
const createPrismaPatchController = (database, _, options) => {
    ...
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const row = yield db[table][action](Object.assign(Object.assign({}, resultOptions), { where: Object.assign(Object.assign({}, (resultOptions.data || {})), findRow) }));
            if (typeof response === "boolean" && !response) {
                res.status(204).json();
            }
            else {
