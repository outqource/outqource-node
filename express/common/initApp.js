...
class InitApp {
  constructor(props) {
    ...
    this.controllers =
      props === null || props === void 0 ? void 0 : props.controllers;
    if ((_a = props.openAPI) === null || _a === void 0 ? void 0 : _a.path) {
      this.openAPI = {
        path: props.openAPI.path,
        options:
          ((_b = props.openAPI) === null || _b === void 0
            ? void 0
            : _b.options) || defaultOpenAPIOptions,
        endPoint:
          ((_c = props.openAPI) === null || _c === void 0
            ? void 0
            : _c.endPoint) || '/api-docs',
      };
    }
  }
  async init() {
    if (this.openAPI) {
      const openAPI = await (0, shared_1.createOpenAPI)(
  ...
  middlewares(middlewares, props) {
    const corsOptions =
      props === null || props === void 0 ? void 0 : props.corsOptions;
    const jwtUserCallback =
      props === null || props === void 0 ? void 0 : props.jwtUserCallback;
    // default
    ...
    if (
      !Array.isArray(middlewares) &&
      (middlewares === null || middlewares === void 0
        ? void 0
        : middlewares.before)
    ) {
    ...
    if (this.openAPI) {
      this.app.use(
        this.openAPI.endPoint,
        ...(0, middlewares_1.swagger)(this.openAPI.path),
      );
    }
  ...
  routers(options) {
    ...
    this.app.use(
      (0, _1.createErrorController)(
        options === null || options === void 0 ? void 0 : options.errorOptions,
      ),
    );
    this.app.use(
      (0, _1.createGlobalController)(
        options === null || options === void 0 ? void 0 : options.globalOptions,
      ),
    );
  }
}
