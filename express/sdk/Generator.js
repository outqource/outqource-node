...
class Generator {
    ...
    static generate(root, dest) {
        return __awaiter(this, void 0, void 0, function* () {
            const generator = new Generator(path.join(process.cwd(), root), dest);
            yield __classPrivateFieldGet(generator, _Generator_instances, "m", _Generator_generate).call(generator);
        });
    }
}
exports.default = Generator;
_Generator_root = new WeakMap(), _Generator_dest = new WeakMap(), _Generator_instances = new WeakSet(), _Generator_generate = function _Generator_generate() {
    return __awaiter(this, void 0, void 0, function* () {
        const tree = yield APITree_1.default.create(__classPrivateFieldGet(this, _Generator_root, "f"), __classPrivateFieldGet(this, _Generator_dest, "f"));
        console.log(tree);
    });
};
